{ annotateRawAstsFrom, attrsToDirs, bash, fail, haskellPkgToRawAsts, jq,
  makeHaskellPkgNixable, runCommand, withDeps, wrap }:

with rec {
  haskellPkgToAsts = attrsToDirs {
    bin = {
      haskellPkgToAsts = wrap {
